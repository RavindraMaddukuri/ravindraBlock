                  ...
                  <div className="row">
                    ...
                    >
                      <div className="card-body">
                        ...
                        <p>I am Worked as a React-Native deeloper. I have worked on 7 projects with Technology React-Native</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="card">
                  <div className="row">
                    ...
                    >
                      <div className="card-body">
                        <div className="h5">Coding Sastra</div>
                        <p>I have Completed Course as a Fullstack Wed Development (MERN)</p>
                      </div>
                    </div>
                  </div>
                </div>
